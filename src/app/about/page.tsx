    ...
    <div className="px-6 lg:px-20 py-10 font-sans text-[#151875]">
      ...
      <section className="my-16 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            { name: "Theodore Mahone", image: "/images/client3.png" },
            { name: "Sara White", image: "/images/client2.png" },
            { name: "Jonas Tim", image: "/images/client1.png" },
          ].map((client, index) => (
        ...
        <p className="mt-6 text-gray-600 px-20">
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Odio consectetur nisi ipsa dolorum voluptas porro eos, expedita dolores atque maxime quaerat voluptatum nobis adipisci illo ad ab. Perferendis, natus architecto!
        </p>
      </section>
    </div>
    <Footer />
