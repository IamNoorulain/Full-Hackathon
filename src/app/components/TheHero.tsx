...
function HeroSection() {
  ...
  return (
    <section className="relative bg-purple-50 py-10 md:py-20 px-5 md:px-10 lg:px-20 flex flex-col md:flex-row items-center justify-between overflow-hidden">

      <div className="md:w-1/4 flex justify-center items-start relative">
        <div className="absolute top-[-200px] md:top-[-350px] left-[-40px] z-10 w-[200px] md:w-[387px]">
          <Image
      ...
      <div className="w-full md:w-1/3 max-w-lg text-center md:text-left flex flex-col justify-center mb-10 md:mb-0">
      ...
      <button
        ...
        className="absolute left-2 md:left-5 top-1/2 transform -translate-y-1/2 bg-white border border-gray-300 rounded-full p-2 hover:bg-gray-100 z-20"
      >
        ❮
      </button>
      <button
        onClick={handleNextSlide}
        className="absolute right-2 md:right-5 top-1/2 transform -translate-y-1/2 bg-white border border-gray-300 rounded-full p-2 hover:bg-gray-100 z-20"
      >
        ❯
      </button>
    </section>
