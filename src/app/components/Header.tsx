...
function Header() {
  ...
  return (
    <>
          ...
          <div className="hidden md:flex items-center gap-x-8">
            <ul className="flex gap-x-8 items-center">
              ...
              <li className="relative">
                ...
                {isPagesDropdownOpen && (
                  <ul className="absolute top-full left-0 mt-2 bg-white shadow-md rounded-md text-black text-sm z-50">
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden flex flex-col items-center px-4 py-2 border-t z-40 bg-white w-full">
          <button
            className="hover:text-[#FB2E86] transition-colors"
