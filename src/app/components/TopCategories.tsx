...
function TopCategories() {
  const categories = [
    { id: 1, img: "/images/chair2.png", name: "Mini LCW Chair", price: "$29.00" },
    { id: 2, img: "/images/chair.png", name: "Mini LCW Chair", price: "$70.00" },
    { id: 3, img: "/images/chair5.png", name: "Mini LCW Chair", price: "$36.00" },
    { id: 4, img: "/images/chair2.png", name: "Mini LCW Chair", price: "$69.00" },
  ];
